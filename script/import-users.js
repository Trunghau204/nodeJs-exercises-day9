...
const EXCEL_FILE_PATH = path.join(__dirname, '../user.xlsx');

function generateRandomPassword(length = 16) {
    // Removed HTML-sensitive characters like <, > to prevent them from hiding
    // parts of the password when rendered in the email's HTML body.
